...
func (*CheckpointsModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_checkpoints_e8be6a4c2b3dc1c8, []int{0}
}
...
type TableCheckpointModel struct {
	...
	Engine    []byte `protobuf:"bytes,2,opt,name=engine,proto3" json:"engine,omitempty"`
	Status    uint32 `protobuf:"varint,3,opt,name=status,proto3" json:"status,omitempty"`
	AllocBase int64  `protobuf:"varint,4,opt,name=alloc_base,json=allocBase,proto3" json:"alloc_base,omitempty"`
	// key is "$path:$offset"
	Chunks               map[string]*ChunkCheckpointModel `protobuf:"bytes,5,rep,name=chunks" json:"chunks,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (*TableCheckpointModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_checkpoints_e8be6a4c2b3dc1c8, []int{1}
}
...
func (m *TableCheckpointModel) GetEngine() []byte {
	if m != nil {
		return m.Engine
	}
	return nil
...
func (*ChunkCheckpointModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_checkpoints_e8be6a4c2b3dc1c8, []int{2}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*ChunkCheckpointModel)(nil), "TableCheckpointModel.ChunksEntry")
...
func (m *TableCheckpointModel) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Engine) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintFileCheckpoints(dAtA, i, uint64(len(m.Engine)))
...
func (m *TableCheckpointModel) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Engine = append(m.Engine[:0], dAtA[iNdEx:postIndex]...)
			if m.Engine == nil {
				m.Engine = []byte{}
			}
			iNdEx = postIndex
...
func init() {
	proto.RegisterFile("lightning/restore/file_checkpoints.proto", fileDescriptor_file_checkpoints_e8be6a4c2b3dc1c8)
}

var fileDescriptor_file_checkpoints_e8be6a4c2b3dc1c8 = []byte{
	// 499 bytes of a gzipped FileDescriptorProto
	,
}
