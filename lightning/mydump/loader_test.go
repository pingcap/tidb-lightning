...
func (s *testMydumpLoaderSuite) TestDataWithoutSchema(c *C) {
	...
	c.Assert(mdl.GetDatabases(), DeepEquals, []*md.MDDatabaseMeta{{
		...
		Tables: []*md.MDTableMeta{{
			...
			Name:       "tbl",
			SchemaFile: "",
			DataFiles:  []*md.SourceFileMeta{{SourceMeta: md.SourceMeta{Path: p, Type: md.SourceTypeSQL}}},
		}},
	}})
}
		...
		Tables: []*md.MDTableMeta{
			{
				...
				DataFiles:  []*md.SourceFileMeta{{SourceMeta: md.SourceMeta{Path: pT2Data, Type: md.SourceTypeSQL}}},
			},
			{
				DB:         "db",
				Name:       "tbl.with.dots",
				SchemaFile: pT1Schema,
				DataFiles:  []*md.SourceFileMeta{{SourceMeta: md.SourceMeta{Path: pT1Data, Type: md.SourceTypeSQL, SortKey: "0001"}}},
			},
		},
	}})
}
			...
			Tables: []*md.MDTableMeta{
				{
					...
					DataFiles:  []*md.SourceFileMeta{{SourceMeta: md.SourceMeta{Path: pA1S1Data, Type: md.SourceTypeSQL, SortKey: "1"}}},
				},
			},
		},
		{
			...
			Tables: []*md.MDTableMeta{
				{
					...
					DataFiles: []*md.SourceFileMeta{
						{SourceMeta: md.SourceMeta{Path: pA0T0Data, Type: md.SourceTypeSQL, SortKey: "1"}},
						{SourceMeta: md.SourceMeta{Path: pA0T1Data, Type: md.SourceTypeSQL, SortKey: "1"}},
						{SourceMeta: md.SourceMeta{Path: pA1T2Data, Type: md.SourceTypeSQL, SortKey: "1"}},
					},
				},
			},
		},
			...
			Tables: []*md.MDTableMeta{
				{
					...
					DataFiles:  []*md.SourceFileMeta{{SourceMeta: md.SourceMeta{Path: pC0T3Data, Type: md.SourceTypeSQL, SortKey: "1"}}},
				},
			},
		},
	})
			...
			Tables: []*md.MDTableMeta{
				{
					...
					DataFiles: []*md.SourceFileMeta{
						{SourceMeta: md.SourceMeta{Path: d1TestData0, Type: md.SourceTypeSQL}},
						{SourceMeta: md.SourceMeta{Path: d1TestData1, Type: md.SourceTypeSQL}},
						{SourceMeta: md.SourceMeta{Path: d1TestData2, Type: md.SourceTypeSQL}},
					},
				},
			},
		},
			...
			Tables: []*md.MDTableMeta{
				{
					...
					DataFiles:  []*md.SourceFileMeta{{SourceMeta: md.SourceMeta{Path: d2AbcData0, Type: md.SourceTypeSQL}}},
				},
			},
		},
	})
