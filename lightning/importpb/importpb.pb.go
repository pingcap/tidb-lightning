...
func (m *UploadRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Chunk != nil {
		nn10, err := m.Chunk.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn10
...
func (m *IngestRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Sst != nil {
		...
		n13, err := m.Sst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
var fileDescriptorImportpb = []byte{
	...
	,
}
