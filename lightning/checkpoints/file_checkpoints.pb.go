...
type TaskCheckpointModel struct {
	...
	TidbAddr     string `protobuf:"bytes,5,opt,name=tidb_addr,json=tidbAddr,proto3" json:"tidb_addr,omitempty"`
	PdAddr       string `protobuf:"bytes,6,opt,name=pd_addr,json=pdAddr,proto3" json:"pd_addr,omitempty"`
	SortedKvDir  string `protobuf:"bytes,7,opt,name=sorted_kv_dir,json=sortedKvDir,proto3" json:"sorted_kv_dir,omitempty"`
}
...
func (*ChunkCheckpointModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_deb32a9bf46ada61, []int{4}
}
...
var fileDescriptor_deb32a9bf46ada61 = []byte{
	...
	,
}
...
func (m *TaskCheckpointModel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TidbAddr) > 0 {
		i -= len(m.TidbAddr)
		copy(dAtA[i:], m.TidbAddr)
		i = encodeVarintFileCheckpoints(dAtA, i, uint64(len(m.TidbAddr)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *TaskCheckpointModel) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TidbAddr", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TidbAddr = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
