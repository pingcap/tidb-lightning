...
func (*CheckpointsModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_checkpoints_bb06b114f990ffe7, []int{0}
}
...
func (*TableCheckpointModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_checkpoints_bb06b114f990ffe7, []int{1}
}
...
func (*EngineCheckpointModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_checkpoints_bb06b114f990ffe7, []int{2}
}
...
func (*ChunkCheckpointModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_checkpoints_bb06b114f990ffe7, []int{3}
}
...
func init() {
	proto.RegisterFile("lightning/checkpoints/file_checkpoints.proto", fileDescriptor_file_checkpoints_bb06b114f990ffe7)
}

var fileDescriptor_file_checkpoints_bb06b114f990ffe7 = []byte{
	// 546 bytes of a gzipped FileDescriptorProto
	,
}
