...
export GO_FAILPOINTS="github.com/pingcap/tidb-lightning/lightning/SetTaskID=return(1234567890);github.com/pingcap/tidb-lightning/lightning/restore/FailIfImportedChunk=return(28)"
